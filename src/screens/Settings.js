...
const Settings = () => {
  const requireAuthentication = useSelector(
    (store) => store.persistentData.requireAuthentication
  );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={{ width: 48, height: 48 }}></TouchableOpacity>
      </View>
      <View
        style={{
          flex: 1,
